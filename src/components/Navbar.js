...
const Navbar = () => {
  ...
  const handleLogout = async () => {
    try {
      await axios.post('https://biharibaceknd-production.up.railway.app/api/v1/auth/logout');
  ...
  const handleResetDone = async () => {
    try {
      ...
      await axios.post('https://biharibaceknd-production.up.railway.app/api/v1/auth/reset-password', { email, newPassword });
